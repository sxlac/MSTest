@uacr
@envnot=prod
Feature: uACR Lab Not Performed Tests
    ...
    Scenario Outline: uACR Not Performed - Provider Unable to Perform - <expected_reason>
        ...
        * match kafkaEvent == {}
        ...
        | 52472     | "Technical issue (please call Mobile Support at (877) 570-9359)" | "Technical issue"          |
        | 52473     | "Environmental issue"                                            | "Environmental issue"      |
        | 52474     | "No supplies or equipment"                                       | "No supplies or equipment" |
        | 52475     | "Insufficient training"                                          | "Insufficient training"    |

    @TestCaseKey=ANC-T751
    Scenario Outline: uACR Not Performed - Member Refused - <expected_reason>
        * def randomNotes = Faker().randomQuote()
        * set evaluation.answers =
            """
            [
        ...
        * match kafkaEvent == {}
        ...
        Examples:
        | answer_id | answer_value                | expected_reason             |
        | 52476     | "Scheduled to complete"     | "Scheduled to complete"     |
        | 52477     | "Member apprehension"       | "Member apprehension"       |
        | 52478     | "Not interested"            | "Not interested"            |
