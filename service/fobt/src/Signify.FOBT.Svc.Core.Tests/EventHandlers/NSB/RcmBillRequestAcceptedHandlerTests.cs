...
public class RcmBillRequestAcceptedHandlerTests
{
    ...
    public async Task Handle_When_BillIdIsFoundAndEvaluationIdPresent()
    {
        ...
        var billResult = A.Fake<FOBTBilling>();
        A.CallTo(() => _mediator.Send(A<GetFobtBillingByBillId>._, A<CancellationToken>._)).Returns(billResult);
    ...
    public async Task Handle_When_BillIdIsFoundAndAdditionalDetailsNotPresent()
    {
        ...
        // Assert
        A.CallTo(() => _mediator.Send(A<GetFobtBillingByBillId>._, CancellationToken.None))
            .MustHaveHappenedOnceExactly();
    ...
    public async Task Handle_When_BillIdIsNotFoundAndEvaluationIdPresent()
    {
        ...
        A.CallTo(() => _mediator.Send(A<GetFobtBillingByBillId>._, A<CancellationToken>._)).Returns((FOBTBilling)null);
