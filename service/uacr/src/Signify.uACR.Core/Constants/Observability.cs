...
public static class Observability
{
    public static class EventParams
    {
        ...
        public const string OrderNotRequestedEvents = "OrderNotRequestedEvents";
    ...
    public static class LabResult
    {
        ...
        public const string LabResultReceivedButProductCodeMissing  = "DpsLabResultReceivedButProductCodeMissing";
