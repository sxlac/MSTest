...
namespace Signify.uACR.Core.ApiClients.EvaluationApi;
...
public interface IEvaluationApi
{
    ...
    /// <returns><see cref="EvaluationVersion"/></returns>
    ...
    Task<EvaluationVersion> GetEvaluationVersion(long evaluationId, string version = "Latest");
    ...
    [Get("/evaluation/{evaluationId}/products")]
    [Headers("Authorization: Bearer")]
    Task<IApiResponse<EvaluationProductCodes>> GetEvaluationProductCodes(long evaluationId);
}
