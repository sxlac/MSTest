...
namespace Signify.uACR.Core.Tests.Models;
...
public class ExamModelTests
{
    ...
    public void Construct_WithInvalidEvaluationId_ThrowsArgOutOfRangeEx(bool examPerformed, long evaluationId, string notes)
    {
        if (examPerformed)
        {
