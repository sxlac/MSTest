...
#   username          = "${data.vault_kv_secret_v2.postgres_admin["username"]}@${var.host_name}"
#   password          = data.vault_kv_secret_v2.postgres_admin["password"]
#   database_username = data.vault_kv_secret_v2.postgres_admin["username"]
