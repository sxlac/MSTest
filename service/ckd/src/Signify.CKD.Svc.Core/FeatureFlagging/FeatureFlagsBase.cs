...
{
    private const string DummyLaunchDarklyUserIdentifier = "Dummy";
    
    private readonly User _ldUser;
    ...
    {
        _ldUser = User.WithKey(DummyLaunchDarklyUserIdentifier);
    ...
    protected bool Evaluate(LaunchDarklyFlagConfig flag)
    {
        return flag.FlagType switch
        {
            LaunchDarklyFlagConfig.FeatureFlagType.Shared when _sharedClient != null =>
                _sharedClient.BoolVariation(flag.FlagName, _ldUser, flag.FlagDefault),
            
            LaunchDarklyFlagConfig.FeatureFlagType.Project when _projectClient != null =>
                _projectClient.BoolVariation(flag.FlagName, _ldUser, flag.FlagDefault),
