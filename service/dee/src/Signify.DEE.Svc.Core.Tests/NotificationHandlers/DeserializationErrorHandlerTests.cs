...
using Signify.DEE.Svc.Core.NotificationHandlers;
using Signify.Dps.Observability.Library.Services;
using Xunit;

namespace Signify.DEE.Svc.Core.Tests.NotificationHandlers;
...
public class DeserializationErrorHandlerTests
{
    ...
    private class DlqHandlerTestData : IEnumerable<object[]>
    {
        public IEnumerator<object[]> GetEnumerator()
        {
            ...
            yield return [new DeserializationError("body", "cdi_holds", 0, "414262", 0, null), new CdiHoldsDlqMessage()];
        }
