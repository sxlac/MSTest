...
public static class Observability
{
    ...
    public static class DeeStatusEvents
    {
        public const string IrisOrderReceivedEvent = "DpsIrisOrderReceived";
        public const string IrisImageReceivedEvent = "DpsIrisImageReceived";
        public const string IrisResultsReceivedEvent = "DpsIrisResultsReceived";
        public const string ImagesSentToIrisEvent = "DpsImagesSentToIris";
        public const string OrderSentToIrisEvent = "DpsOrderSentToIris";
    }
