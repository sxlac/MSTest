...
| <a name="input_okta_auth_server_policy_priority"></a> [okta\_auth\_server\_policy\_priority](#input\_okta\_auth\_server\_policy\_priority) | The priority of the auth server policy | `number` | n/a | yes |
